...
class ElasticSearchQueryTest extends \Neos\Flow\Tests\FunctionalTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->siteNode = $rootNode->createNode('welcome', $this->nodeTypeManager->getNodeType('Neos.Neos.NodeTypes:Page'));
    ...
    public function filterByNodeType()
    {
        $resultCount = $this->getQueryBuilder()
            ...
            ->nodeType('Neos.Neos.NodeTypes:Page')
            ->count();
    ...
    {
        $newNode1 = $this->siteNode->createNode('test-node-1', $this->nodeTypeManager->getNodeType('Neos.Neos.NodeTypes:Page'));
        $newNode1->setProperty('title', 'chicken');

        $newNode2 = $this->siteNode->createNode('test-node-2', $this->nodeTypeManager->getNodeType('Neos.Neos.NodeTypes:Page'));
        $newNode2->setProperty('title', 'chicken');

        $newNode3 = $this->siteNode->createNode('test-node-3', $this->nodeTypeManager->getNodeType('Neos.Neos.NodeTypes:Page'));
